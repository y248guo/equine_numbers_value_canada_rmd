...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for each province in Canada between 1906 and 1972", out.width="100%"}
start_year <- 1940
...
knitr::kable(max_horses,
             caption = "Table 1. Summary of maximum and minimum horse population for each province between 1940 and 1972")
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Line plot of the horse population in the targeted province", out.width="50%"}
